...
public class Main {
    public static void main(String[] args) {
        ...
        /*control.mostrarClienteYCantidadCuentas(nroDocumento, Saldo)*/
        System.out.println(control.mostrarClienteYCantidadCuentas(111, 10000));

        System.out.println(control.mostrarClienteYCantidadCuentas(222, 900));
